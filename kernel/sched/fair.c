				 ...
				 unsigned long *max)
{
	...
	/*
	 * android15-6.6 android_rvh_effective_cpu_util hook: upstream moved
	 * effective_cpu_util() here from core.c and dropped the type/p
	 * parameters; type=0 (FREQUENCY_UTIL) and p=NULL are passed as the
	 * closest remaining context.
	 */
	trace_android_rvh_effective_cpu_util(cpu, util_cfs, scale, 0, NULL,
					     &new_util);
