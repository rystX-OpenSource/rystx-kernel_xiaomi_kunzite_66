...
/*
 * android15-6.6 does not carry the cpufreq core pressure reporting that
 * feeds this in android16-6.12, so report no pressure until that lands;
 * the scheduler side (get_actual_cpu_capacity()) follows the upstream
 * structure.
 */
